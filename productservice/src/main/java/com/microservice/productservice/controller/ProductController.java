...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> getProductById(@PathVariable("id") long productId) {
        log.info("ProductController | getProductId is called");
    ...
    public ResponseEntity<Void> reduceQuantity(@PathVariable("id") long productId,
        ...
        log.info("ProductController | reduceQuantity called");
    ...
    public ResponseEntity<Void> deleteProductById(@PathVariable("id") long productId) {
        log.info("ProductController | deleteProductById called");
        log.info("ProductController | deleteProduct for id: {}", productId);
